...
def get_data(html_data: str) -> List[dict]:
    ...
    for element in shawarma_element_boxes:
        ...
        try:
            ...
            # title
            title_raw = element.find(
                name='div', attrs='js-store-prod-name').text
            if not title_raw:
                continue
            ...
            # ingredients
            ingredients = element.find(
                name='div', attrs='js-store-prod-descr').text.strip()
